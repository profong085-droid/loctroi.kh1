...
export const productsData: Product[] = [
  ...
  { 
    ...
    categoryKh: "គ្រាប់ពូជ", 
    usage: { 
      kh: "អាយុកាលខ្លី ៩០ ទៅ ៩៥ថ្ងៃ ក្រោយព្រួស ឬសាប", 
      en: "Short duration 90-95 days after sowing.", 
      vi: "Thời gian sinh trưởng ngắn 90-95 ngày sau khi sạ.", 
      ar: "فترة نمو قصيرة 90-95 يومًا", 
      hi: "बुवाई के 90-95 दिन बाद छोटी अवधि।", 
      ja: "播種後90〜95日の短期間。", 
      ko: "파종 후 90-95일의 짧은 기간.", 
      zh: "播种后 90-95 天，生育期短。" 
    }, 
    ingredients: { kh: "ឆាប់ៗនេះ", en: "Coming soon", vi: "Sắp ra mắt", ar: "قريباً", hi: "जल्द आ रहा है", ja: "近日公開", ko: "곧 출시 예정", zh: "即将推出" }, 
    benefits: [ 
      { 
        kh: "ផ្តល់ទិន្នផលខ្ពស់ចន្លោះពី ៨ ទៅ ១០ តោន ក្នុងមួយហិកតា", 
        en: "Provides high and stable yield (8-10 tons/ha).", 
        vi: "Cho năng suất cao (8-10 tấn/ha) và ổn định.", 
        ar: "يوفر عائدًا مرتفعًا ومستقرًا (8-10 طن / هكتار).", 
        hi: "उच्च और स्थिर उपज (8-10 टन/हेक्टेयर) प्रदान करता है।", 
        ja: "高くて安定した収量（8〜10トン/ヘクタール）を提供します。", 
        ko: "높고 안정적인 수확량(8-10톤/ha)을 제공합니다.", 
        zh: "提供高产稳定的产量（8-10 吨/公顷）。" 
      },
      { 
        kh: "ធន់នឹងជំងឺមមាចត្នោត ដង្កូវស៊ីរូងដើម និងជំងឺប្លាស បានយ៉ាងល្អ", 
        en: "Strong resistance to brown planthoppers, stem borers, and blast disease.", 
        vi: "Kháng tốt rầy nâu, sâu đục thân và bệnh đạo ôn.", 
        ar: "مقاومة قوية لمرض بلانثوبير البني وحفار الساق ومرض الانفجار.", 
        hi: "भूरे रंग के प्लैन्थोपर, तना छेदक और ब्लास्ट रोग के प्रति मजबूत प्रतिरोध।", 
        ja: "トビイロウンカ、ニカメイチュウ、いもち病に強い耐性があります。", 
        ko: "벼멸구, 줄기명나방, 도열병에 대한 저항성이 강합니다.", 
        zh: "对褐飞虱、二化螟、稻瘟病有很强的抗性。" 
      },
      { 
        kh: "គុណភាពអង្ករល្អ គ្រាប់វែង ថ្លា គ្មានពោះស និងចម្អិនជាបាយទន់ឆ្ងាញ់", 
        en: "Excellent quality with long, clear grains, no chalkiness; soft and delicious when cooked.", 
        vi: "Chất lượng tuyệt hảo, hạt dài, trong, không bạc bụng; nấu cơm mềm ngon.", 
        ar: "جودة ممتازة مع حبوب طويلة وواضحة، بدون طباشير؛ طرية ولذيذة عند الطهي.", 
        hi: "लंबे, साफ दानों के साथ उत्कृष्ट गुणवत्ता, कोई चाकपन नहीं; पकने पर नरम और स्वादिष्ट।", 
        ja: "長くて透き通った粒で白っぽさがなく、高品質です。炊き上がりは柔らかくておいしいです。", 
        ko: "길고 투명한 낱알로 백악질이 없는 우수한 품질; 요리하면 부드럽고 맛있습니다.", 
        zh: "品质优良，颗粒细长剔透，无白垩；煮熟后松软可口。" 
      },
      { 
        kh: "ត្រូវនឹងស្តង់ដារទីផ្សារ និងងាយស្រួលក្នុងការនាំចេញទៅក្រៅប្រទេស", 
        en: "Meets market standards and is highly suitable for export.", 
        vi: "Đạt tiêu chuẩn thị trường và rất phù hợp để xuất khẩu.", 
        ar: "يفي بمعايير السوق ومناسب جدا للتصدير.", 
        hi: "बाजार के मानकों को पूरा करता है और निर्यात के लिए अत्यधिक उपयुक्त है।", 
        ja: "市場基準を満たしており、輸出に非常に適しています。", 
        ko: "시장 기준을 충족하며 수출에 매우 적합합니다.", 
        zh: "符合市场标准，非常适合出口。" 
      }
    ],
    relatedImages: [
